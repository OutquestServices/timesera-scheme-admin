    ...
    <div className="w-full max-h-[1000px]">
      <div className="w-full h-full flex gap-[20px] justify-center items-start">
        <div
          style={{
            background:
              "radial-gradient(50% 50% at 50% 50%, #F9F9F9 81.83%, #F2F4FF 100%)",
          }}
          className="flex-1 w-full  rounded-2xl min-h-[180px] flex items-center justify-center relative overflow-hidden "
        >
          <a
            href={"/"}
            className="flex-1 flex flex-col items-center justify-center w-full h-[60%] border border-[#000] border-t-0 border-l-0 border-b-0"
          >
            ...
            <span className="flex items-center justify-center w-full pt-[5px]">
              <a
                href={"/"}
                className="w-fit flex gap-[5px] px-[10px] mr-[5px] rounded-md items-center justify-center bg-[#52BD91]"
              >
          ...
          <a
            href={"/"}
            className="flex-1 flex flex-col items-center justify-center w-full h-[60%] "
          >
            <span className="flex flex-col items-center justify-center">
              <span className="w-[53px] h-[53px] flex items-center justify-center bg-[#D9D9D9] rounded-[50%]">
                <svg
        ...
        <div className="flex-1 max-h-[180px] w-full h-full flex flex-col rounded-xl overflow-hidden relative ">
          {/* <div className='absolute top-0 left-0 z-20'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="53" height="67" viewBox="0 0 103 87" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M36.061 87C72.5118 87 102.061 57.4508 102.061 21C102.061 -15.4508 72.5118 -45 36.061 -45C-0.389759 -45 -29.939 -15.4508 -29.939 21C-29.939 57.4508 -0.389759 87 36.061 87ZM36.721 65.88C61.1431 65.88 80.941 46.082 80.941 21.66C80.941 -2.76203 61.1431 -22.56 36.721 -22.56C12.299 -22.56 -7.49896 -2.76203 -7.49896 21.66C-7.49896 46.082 12.299 65.88 36.721 65.88Z" fill="#fff" />
                        </svg>
                    </div> */}
          ...
          <div className="absolute bottom-0 right-0 z-20">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M66.061 132C102.512 132 132.061 102.451 132.061 66C132.061 29.5492 102.512 0 66.061 0C29.6102 0 0.0610352 29.5492 0.0610352 66C0.0610352 102.451 29.6102 132 66.061 132ZM66.721 110.88C91.1431 110.88 110.941 91.082 110.941 66.66C110.941 42.238 91.1431 22.44 66.721 22.44C42.299 22.44 22.501 42.238 22.501 66.66C22.501 91.082 42.299 110.88 66.721 110.88Z"
                fill="#fff"
              />
            </svg>
          </div>
          <a
            ...
            className=" flex flex-col gap-[2px] py-[5px] px-[15px] relative"
          >
            <span className="absolute top-0 right-0">
              ...
              >
                <path
                  d="M32.3447 32.8125C29.9081 32.8125 27.5712 33.7805 25.8482 35.5035C24.1252 37.2264 23.1572 39.5633 23.1572 42C23.1572 44.4367 24.1252 46.7736 25.8482 48.4965C27.5712 50.2195 29.9081 51.1875 32.3447 51.1875C34.7814 51.1875 37.1183 50.2195 38.8413 48.4965C40.5643 46.7736 41.5322 44.4367 41.5322 42C41.5322 39.5633 40.5643 37.2264 38.8413 35.5035C37.1183 33.7805 34.7814 32.8125 32.3447 32.8125ZM28.4072 42C28.4072 40.9557 28.8221 39.9542 29.5605 39.2158C30.2989 38.4773 31.3004 38.0625 32.3447 38.0625C33.389 38.0625 34.3905 38.4773 35.129 39.2158C35.8674 39.9542 36.2822 40.9557 36.2822 42C36.2822 43.0443 35.8674 44.0458 35.129 44.7842C34.3905 45.5227 33.389 45.9375 32.3447 45.9375C31.3004 45.9375 30.2989 45.5227 29.5605 44.7842C28.8221 44.0458 28.4072 43.0443 28.4072 42Z"
                  fill="black"
                />
                <path
                  d="M46.8505 13.4295L38.5056 1.72986L7.82198 26.2421L6.12098 26.2237V26.25H4.78223V57.75H59.9072V26.25H57.382L52.3577 11.5526L46.8505 13.4295ZM51.8354 26.25H25.5119L45.118 19.5667L49.1132 18.2884L51.8354 26.25ZM41.6635 15.1987L21.4247 22.0972L37.453 9.29248L41.6635 15.1987ZM10.0322 47.6936V36.3011C11.1397 35.9087 12.1456 35.274 12.9767 34.4434C13.8077 33.6128 14.4429 32.6072 14.836 31.5H49.8535C50.2464 32.6076 50.8815 33.6137 51.7125 34.4447C52.5436 35.2757 53.5496 35.9108 54.6572 36.3037V47.6962C53.5496 48.0891 52.5436 48.7242 51.7125 49.5553C50.8815 50.3863 50.2464 51.3923 49.8535 52.5H14.8412C14.448 51.3914 13.8121 50.3846 12.9802 49.5531C12.1482 48.7215 11.141 48.0863 10.0322 47.6936Z"
                  fill="black"
                />
              </svg>
            </span>
            ...
            <span className="flex gap-[3px] items-center justify-start">
              <p className="text-[14px] text-black font-semibold z-30 relative">
                Todays Collection:{" "}
              </p>
            </span>

            <span>
              <p className="text-[20px] text-black font-bold z-30 relative">
                ₹ {formatRupees(todayCollection)}
              </p>
            </span>
            ...
            <span className="flex items-center justify-end w-full pt-[5px]">
              <a
                href={"/"}
                className="w-fit flex gap-[5px] px-[10px] rounded-md items-center justify-end bg-[#52BD91]"
              >
                <p className="text-[12px] text-black font-normal">Check </p>
                <svg
                  xmlns="https://www.w3.org/2000/svg"
