        ...
        <div className='w-full max-h-[1000px]'>
            <div className='w-full h-full flex gap-[20px] justify-center items-start'>
                <div style={{ background: "radial-gradient(50% 50% at 50% 50%, #F9F9F9 81.83%, #F2F4FF 100%)" }} className='flex-1 w-full  rounded-2xl min-h-[180px] flex items-center justify-center relative overflow-hidden '>
                    ...
                    <a href={"/birthdays"} className='flex-1 flex flex-col items-center justify-center w-full h-[60%] border border-[#000] border-t-0 border-l-0 border-b-0'>
                        ...
                        <div className='flex items-center justify-center w-full pt-[5px]'>
                            <a href={"/birthdays"} className='w-fit flex gap-[5px] px-[10px] mr-[5px] rounded-md items-center justify-center bg-[#52BD91]'>
                    ...
                    <a href={"/anniversaries"} className='flex-1 flex flex-col items-center justify-center w-full h-[60%] '>
                        <div className='flex flex-col items-center justify-center'>
                            <div className='w-[53px] h-[53px] flex items-center justify-center bg-[#D9D9D9] rounded-[50%]'>
                        ...
                        <div className='flex items-center justify-center w-full pt-[5px]'>
                            <a href={"/anniversaries"} className='w-fit flex gap-[5px] px-[10px] mr-[5px] rounded-md items-center justify-center bg-[#52BD91]'>
                                <p className='text-[12px] text-black font-normal'>Check </p>
                                <svg xmlns="https://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                                    <path d="M1 1L5 5L1 9" stroke="#F8F8F8" stroke-width="0.8" />
                                </svg>
                ...
                <div className='flex-1 max-h-[180px] w-full h-full flex flex-col rounded-xl overflow-hidden relative '>
                    ...
                    <a href={"/todaydue"} style={{ background: "radial-gradient(35.46% 49.1% at 49.1% 50%, #EEF2FF 0%, #DAE2FF 100%)" }} className=' flex flex-col gap-[2px] py-[5px] px-[15px] relative'>
                        ...
                        <div className='flex items-center justify-end w-full pt-[5px]'>
                            <a href={"/todaydue"} className='w-fit flex gap-[5px] px-[10px] rounded-md items-center justify-end bg-[#52BD91]'>
                                <p className='text-[12px] text-black font-normal'>Check </p>
                                <svg xmlns="https://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                                    <path d="M1 1L5 5L1 9" stroke="#F8F8F8" stroke-width="0.8" />
                                </svg>
                    ...
                    <a href={"/totaldue"} style={{ background: "radial-gradient(35.46% 49.1% at 49.1% 50%, #EEF2FF 0%, #DAE2FF 100%)" }} className=' flex flex-col gap-[2px] py-[5px] px-[15px]  relative'>
                        ...
                        <div className='flex items-center justify-end w-full pt-[5px] z-30 relative'>
                            <a href={"/totaldue"} className='w-fit flex gap-[5px] px-[10px] rounded-md items-center justify-end bg-[#52BD91]'>
                                <p className='text-[12px] text-black font-normal'>Check </p>
                                <svg xmlns="https://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                                    <path d="M1 1L5 5L1 9" stroke="#F8F8F8" stroke-width="0.8" />
                                </svg>
