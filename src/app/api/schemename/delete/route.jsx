...
export async function DELETE(request) {
    ...
    try {
        ...
        if (relatedUsers.length > 0) {
            return NextResponse.json({ error: 'Cannot delete, scheme name is associated with users' }, { status: 400 });
        }
        ...
        return NextResponse.json({ error: 'Failed to delete scheme name' }, { status: 500 });
    } finally {
