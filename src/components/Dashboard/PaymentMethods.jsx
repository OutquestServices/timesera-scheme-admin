  ...
  return (
    <div>
      <div className=" w-full h-full flex flex-col gap-[3px] ">
        <div
          className="w-full h-full rounded-xl px-[15px] py-[1px] flex justify-between items-center"
          style={{
            background:
