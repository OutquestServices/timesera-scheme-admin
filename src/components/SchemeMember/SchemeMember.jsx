...
const SchemeMember = () => {
  ...
  const handleDelete = async (cardNo) => {
    try {
      ...
      alert(
        "An error occurred while deleting the scheme member. Please try again."
      );
    }
  };
      ...
      <div className="w-full h-full">
        ...
        <div className="w-full pb-[10px] flex flex-col gap-[10px] sm:gap-[15px] lg:gap-[20px] items-center justify-center">
              ...
              <div className="flex w-full items-center justify-center gap-[20px] px-[20px]">
                <div className="basis-[33%] w-full flex items-center justify-center gap-[5px] sm:gap-[10px]">
                  ...
                  <select
                    ...
                    value={schemeType}
                    id=""
                    className="p-[10px] sm:p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
                ...
                <div className="basis-[33%] flex items-center justify-between">
                  <p className="basis-[50%] text-[14px] sm:text-[16px] lg:text-[14px] text-[#182456] font-semibold">
                    Joining Date
                  </p>
                  <input
                    type="date"
                    ...
                    id=""
                    className=" w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
                ...
                <div className="basis-[33%] flex items-center justify-between">
                  <p className="basis-[40%] text-[14px] sm:text-[16px] lg:text-[14px] text-[#182456] font-semibold">
                    Mobile No
                  </p>
                  <input
                    type="text"
                    ...
                    className="basis-[60%] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
            ...
            <div className="flex flex-col px-[20px] py-[20px] gap-[10px]">
              <div className="flex items-center justify-center gap-[20px]">
                <div className="basis-[40%] flex items-center justify-between">
                  <p className="basis-[30%] text-[14px] sm:text-[16px] lg:text-[14px] text-[#182456] font-semibold">
                    Scheme Name
                  </p>
                  <select
                    value={schemeName}
                    ...
                    name=""
                    id=""
                    className="basis-[70%] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
                    onKeyDown={(e) => handleKeyDown(e, "memberName")}
                    ref={inputRefs.schemeName}
                  >
                    <option value="">Select Name</option>
                    {schemeNames?.map((type) => (
                      <option key={type?.id} value={type?.SchemeName}>
                        {type?.SchemeName}
                      </option>
                    ))}
                  </select>
                ...
                <div className="basis-[20%] flex items-center justify-between">
                  <button
                    ...
                    className="border border-black px-[20px] py-[5px] rounded-lg hover:bg-black bg-[#182456] text-white"
                  >
                    Generate Card No
                  </button>
                </div>
                <div className="basis-[40%] flex items-center justify-start">
                  <p className="basis-[20%] text-[14px] sm:text-[16px] lg:text-[14px] text-[#182456] font-semibold">
                    Card No
                  </p>
                  <input
                    type="text"
                    ...
                    id=""
                    className="basis-[80%] max-w-[120px] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black text-center bg-[#52BD91] text-white"
              ...
              <div className="flex items-center justify-center gap-[20px]">
                <div className="basis-[33%] flex items-center justify-between">
                  <p className="basis-[35%] text-[14px] sm:text-[16px] lg:text-[14px] text-[#182456] font-semibold">
                    Member Name
                  </p>
                  <input
                    type="text"
                    ...
                    id=""
                    className="basis-[65%] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
              ...
              <div className="flex items-center justify-center gap-[20px]">
                <div className="basis-[33%] flex items-center justify-between">
                  ...
                  <input
                    ...
                    onKeyDown={(e) => handleKeyDown(e, "landline")}
                ...
                <div className="basis-[33%] flex items-center justify-between">
                  ...
                  <input
                    ...
                    onKeyDown={(e) => handleKeyDown(e, "mobile1")}
                    ref={inputRefs.landline}
                    id=""
                    className="basis-[70%] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
                ...
                <div className="basis-[33%] flex items-center justify-between">
                  ...
                  <input
                    ...
                    onKeyDown={(e) => handleKeyDown(e, "mobile2")}
                    ref={inputRefs.mobile1}
                    className="basis-[65%] w-full p-[5px] text-[14px] rounded-lg focus:outline-none border border-black"
              ...
              <div className="flex items-center justify-center gap-[20px]">
                ...
                <div className="basis-[33%] flex items-center justify-between">
                  ...
                  <input
                    ...
                    id=""
                    value={dob}
                    onKeyDown={(e) => handleKeyDown(e, "anniversary")}
                    ref={inputRefs.dob}
              ...
              <div className="flex items-center justify-center gap-[20px]">
                <div className="basis-[33%] flex items-center justify-between">
                  ...
                  <input
                    ...
                    id=""
                    value={anniversary}
                    onKeyDown={(e) => handleKeyDown(e, "nominee")}
                    ref={inputRefs.anniversary}
          ...
          <div className="w-full flex items-center justify-center gap-[10px] sm:gap-[15px] lg:gap-[20px]">
            ...
            <Link
              href={"/"}
              ref={inputRefs.cancelButton}
              className="px-[20px] sm:px-[30px] w-[120px] rounded-md py-[5px] sm:py-[5px] bg-[#182456] text-white font-semibold flex items-center justify-center cursor-pointer"
            >
              CANCEL
            </Link>
          </div>
                ...
                >
                  ...
                  <td className="border border-black p-1 text-[14px]">
                    ...
                    <button
                      ...
                      onClick={() => handleDelete(type.CardNo)}
                    >
                      <MdDelete />
                    </button>
                  </td>
