        ...
        <div className='w-full max-h-[100000px]'>
            <div className='w-full h-full flex flex-col gap-[10px] sm:gap-[15px] lg:gap-[20px]'>
                <div className='px-[10px] sm:px-[20px] lg:px-[40px] py-[5px] sm:py-[10px] lg:py-[15px]'>
                    <div className='w-full h-full px-[15px] sm:px-[30px] lg:px-[45px] py-[10px] sm:py-[15px] lg:py-[20px] rounded-md flex items-center gap-[5px] sm:gap-[8px] lg:gap-[12px]' style={{ background: "linear-gradient(270deg, #0A0E16 5.64%, #182456 97.55%)" }}>
                        <div className='basis-[50%] flex items-center justify-between w-full h-full'>
                            <h1 className='text-[#fff] text-[20px] sm:text-[24px] lg:text-[28px] font-semibold pl-[10px] border-l-8 rounded-s-md border-[#52BD91]'>Receipt Entry</h1>

                            <div className='flex flex-col items-center text-center justify-center'>
                                <p className='text-white text-[14px] sm:text-[15px] lg:text-[16px] font-semibold'>Financial Year</p>
                ...
                <div className='w-full px-[20px] sm:px-[50px] lg:px-[100px] max-h-full mb-[20px]'>
                    <div className='w-full h-full flex gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                        <div className='basis-[50%] border-2 border-[#182456] rounded-xl overflow-hidden'>
                            <div className='w-full h-[190px] flex flex-col gap-[5px] sm:gap-[9px] lg:gap-[13px] items-center justify-center' style={{ background: "radial-gradient(50% 50% at 50% 50%, rgba(44, 67, 161, 0.00) 0%, rgba(44, 67, 161, 0.18) 100%), url(/receiptbanner.png) lightgray 0px -110.255px / 100% 221.945% no-repeat" }}>
                                ...
                                <div className='flex items-center justify-center gap-[10px] sm:gap-[15px] lg:gap-[20px] text-[14px] sm:text-[16px] lg:text-[18px] font-semibold text-[#0D1327]'>
                                    <div className='flex flex-col justify-start items-start text-start'>
                                        <h1 className='underline pb-[2px] sm:px-[3px] lg:px-[4px]'>Rec Date</h1>
                                        <input type="date" className='rounded-md focus:outline-none px-[5px] sm:px-[10px] lg:px-[15px] py-[2px] sm:py-[4px] lg:py-[6px] max-w-[250px]' />
                                    </div>


                                    <div className='flex flex-col justify-start items-start text-start'>
                                        <h1 className='underline pb-[2px] sm:px-[3px] lg:px-[4px]'>Receipt No</h1>
                                        <input type="text" className='rounded-md focus:outline-none px-[5px] sm:px-[10px] lg:px-[15px] py-[2px] sm:py-[4px] lg:py-[6px] max-w-[250px]' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='w-full flex flex-col items-center justify-between gap-[5px] sm:gap-[7px] lg:gap-[10px] text-[14px] sm:text-[16px] lg:text-[18px] font-semibold text-[#0D1327] py-[10px] sm:py-[15px] lg:py-[20px] px-[20px] sm:px-[50px] lg:px-[100px]'>
                                <div className='flex items-center justify-between w-full'>
                                    <div className='flex gap-[5px] sm:gap-[7px] lg:gap-[9px] items-center justify-center'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" fill="none">
                                            <path d="M15.6 12.8C15.6 15.124 13.724 17 11.4 17C9.076 17 7.2 15.124 7.2 12.8C7.2 10.476 9.076 8.60005 11.4 8.60005C13.724 8.60005 15.6 10.476 15.6 12.8ZM19.8 28.2H3V25.4C3 22.306 6.766 19.8 11.4 19.8C16.034 19.8 19.8 22.306 19.8 25.4M31 17V19.8H18.4V17M31 11.4V14.2H18.4V11.4M31 5.80005V8.60005H18.4V5.80005H31Z" fill="#182456" />
                                        </svg>
                                        <p className='text-[20px] sm:text-[24px] lg:text-[28px] text-[#182456]'>Card Details</p>
                                    </div>

                                    <div className='flex flex-col gap-[2px] sm:gap-[5px]'>
                                        <p className='underline text-[14px] sm:text-[16px] lg:text-[18px]'>Card No</p>
                                        <input type="text" className='px-[5px] sm:px-[10px] lg:px-[15px] py-[3px] sm:py-[5px] text-[20px] sm:text-[24px] lg:text-[28px] text-[#52BD91] focus:outline-none border border-black rounded-xl max-w-[110px]' />
                                    </div>
                                </div>

                                <div className='w-full flex flex-col gap-[3px] sm:gap-[5px]'>
                                    <p className='underline text-[16px] sm:text-[18px] lg:text-[20px] text-[#182456] font-normal'>Scheme</p>
                                    <div className='grid grid-cols-2 w-full gap-[10px] sm:gap-[15px] lg:gap-[20px]'>
                                        <select name="type" id="" className='w-full focus:outline-none px-[10px] sm:px-[15px] py-[3px] sm:py-[5px] lg:py-[10px] border border-black rounded-lg text-[14px] sm:text-[16px] '>
                                            <option value="">Select Type</option>
                                            <option value="">Gold Wallet</option>
                                            <option value="">Silver Wallet</option>
                                        </select>
                                ...
                                <div className='w-full flex flex-col gap-[5px] sm:gap-[10px] lg:gap-[12px] pt-[10px]'>
                                    <div className='flex text-[14px] sm:text-[16px] lg:text-[18px] items-center justify-between gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                        ...
                                        <input type="text" className='px-[5px] sm:px-[10px] lg:px-[15px] py-[3px] sm:py-[5px] focus:outline-none border border-black rounded-lg max-w-[350px] w-full' />
                                    </div>
                                    ...
                                    <div className='flex text-[14px] sm:text-[16px] lg:text-[18px] items-center justify-between gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                        ...
                                        <textarea name="" id="" rows={4} className='max-w-[350px] w-full px-[5px] sm:px-[10px] lg:px-[15px] py-[3px] sm:py-[5px] focus:outline-none border border-black rounded-lg'></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col gap-[10px] sm:gap-[15px] lg:gap-[20px] py-[10px] sm:py-[15px] lg:py-[20px]'>
                                <h1 className='px-[20px] sm:px-[50px] lg:px-[100px] text-[20px] sm:text-[24px] lg:text-[28px] text-[#182456] font-semibold'>Scheme Details</h1>
                                ...
                                <div className='flex flex-col gap-[4px] sm:gap-[8px] px-[10px] sm:px-[20px] lg:px-[40px]'>
                                    <div className='w-full flex gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                        <div className='flex-1 flex text-[14px] sm:text-[16px] w-full lg:text-[18px] items-center justify-between gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                            ...
                                            <input type="text" className=' px-[3px] py-[3px] sm:py-[5px] focus:outline-none border border-black rounded-lg max-w-[150px] w-full' />
                                        </div>
                        ...
                        <div className='basis-[50%] flex flex-col gap-[20px]  border-2 border-[#182456] rounded-xl py-[10px] sm:py-[20px] lg:py-[30px]'>
                            ...
                            <h1 className='px-[20px] sm:px-[50px] lg:px-[100px] text-[20px] sm:text-[24px] lg:text-[28px] text-[#182456] font-semibold'>Receipt Details</h1>
                            ...
                            <div className='flex flex-col gap-[4px] sm:gap-[8px] px-[10px] sm:px-[20px] lg:px-[40px]'>
                                <div className='w-full flex gap-[5px] sm:gap-[7px] lg:gap-[10px]'>
                                    <div className='flex flex-col text-[14px] sm:text-[16px] w-full lg:text-[18px] items-center justify-between gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                        <p className='text-[16px] sm:text-[18px] lg:text-[20px] font-semibold text-[#182456]'>Collection Point</p>
                            ...
                            <div className='flex flex-col gap-[20px] w-full px-[10px] sm:px-[20px] lg:px-[40px]'>
                                <div className='w-full flex flex-col gap-[3px] sm:gap-[5px]'>
                                    <p className='underline text-[16px] sm:text-[18px] lg:text-[20px] text-[#182456] font-normal'>Gold Wt</p>
                                    <div className='grid grid-cols-2 w-full gap-[10px] sm:gap-[15px] lg:gap-[20px]'>
                                        <input type="text" className='w-full focus:outline-none px-[10px] sm:px-[15px] py-[3px] sm:py-[5px] lg:py-[10px] border border-black rounded-lg text-[14px] sm:text-[16px] ' />
                                ...
                                <div className='w-full flex flex-col gap-[5px] sm:gap-[10px] lg:gap-[12px] pt-[10px]'>
                                    ...
                                    <div className='flex text-[14px] sm:text-[16px] lg:text-[18px] items-center justify-between gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                                        ...
                                        <textarea name="" id="" rows={3} className='max-w-[350px] w-full px-[5px] sm:px-[10px] lg:px-[15px] py-[3px] sm:py-[5px] focus:outline-none border border-black rounded-lg'></textarea>
                                    </div>
                                </div>
                            </div>
