    ...
    return (
        <div>
            <div className='flex w-full h-full gap-[10px] lg:gap-[25px] xl:gap-[40px] items-start justify-start'>
                <div className='basis-[40%] w-full h-full flex flex-col'>
                    ...
                    <div className='w-full px-[20px] grid grid-cols-2 -mt-[90px] lg:grid-cols-4 items-center justify-center gap-[5px] '>
                        <div className='w-full max-h-[150px] overflow-hidden rounded-md flex flex-col items-center justify-center '>
                            ...
                            <div className='w-full h-[80px] bg-white border border-black rounded-md -mt-[15px] -z-20 '>
                        ...
                        <div className='w-full max-h-[150px] overflow-hidden rounded-md flex flex-col items-center justify-center '>
                            ...
                            <div className='w-full h-[80px] bg-white border border-black rounded-md -mt-[15px] -z-20 '>
                                ...
                                <div className='w-full h-full p-[5px] flex flex-col items-center justify-center text-center  relative z-30 text-black'>
                                    ...
                                    <p className='text-[18px] font-bold text-[#52BD91]'>Regular</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='w-full max-h-[150px] overflow-hidden rounded-md flex flex-col items-center justify-center '>
                            ...
                            <div className='w-full h-[80px] bg-white border border-black rounded-md -mt-[15px] -z-20 '>
                                ...
                                <div className='w-full h-full p-[5px] flex flex-col items-center justify-center text-center  relative z-30 text-black'>
                                    <p className='text-[12px] font-medium text-[#000] '>Invoice Number</p>
                                    <p className='text-[18px] font-bold text-[#FF0803]'>#01283</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className='basis-[60%]  flex w-full h-full gap-[25px]'>
                    ...
                    <div className='max-w-[280px] w-full ml-auto h-full '>
                        <div className='w-full h-full ml-auto overflow-y-auto custom-scrollbar max-h-[180px] p-[10px] rounded-xl border border-[#52bd91b3] flex flex-col gap-[17px]'>
