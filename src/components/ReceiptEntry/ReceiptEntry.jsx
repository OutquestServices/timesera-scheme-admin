    ...
    return (
        <div className='w-full max-h-[100000px]'>
            <div className='w-full h-full flex flex-col gap-[10px] sm:gap-[15px] lg:gap-[20px]'>
                ...
                <div className='w-full px-[20px] sm:px-[50px] lg:px-[100px] max-h-full'>
                    <div className='w-full h-full flex items-center justify-center gap-[5px] sm:gap-[10px] lg:gap-[15px]'>
                        ...
                        <div className='basis-[50%] border-2 border-[#182456] flex'></div>
                    </div>
                </div>
            </div>
        </div>
