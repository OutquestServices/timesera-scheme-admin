...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div
      className={`h-screen overflow-y-auto custom-scrollbar2 bg-[#182456] text-white flex flex-col fixed transition-all duration-300 ${
        isOpen ? " w-52" : "w-16"
      }`}
    >
      <div className="sticky top-0 w-full bg-[#182456] flex flex-col items-center">
        ...
        <div
          className={`bg-[#182456] w-full py-2 -z-30 flex flex-col items-center ${
            isOpen ? "-mt-[40px]" : "-mt-[0px]"
          } `}
        >
          <a
            href={"/"}
            className="max-w-[150px] mx-auto flex flex-col items-center justify-center gap-1"
          >
      ...
      <div className="mt-4 w-full text-[14px]">
        ...
        <button
          ...
          className="flex w-full items-center py-3 pl-4 hover:bg-gray-700 cursor-pointer"
        >
          <FaReceipt />
        ...
        {clickReports && (
          <div className="flex flex-col">
            <a
              href={"/memberreport"}
              className="flex border-b border-[#4FC997] items-center py-3 pl-4 hover:bg-gray-700 cursor-pointer"
            >
              {/* <FaFileContract /> */}
              {isOpen && <span className="ml-4">Member Report</span>}
            </a>
            <a
              href={"/settlementreport"}
              className="flex border-b border-[#4FC997] items-center py-3 pl-4 hover:bg-gray-700 cursor-pointer"
            >
              {/* <FaFileAlt /> */}
